        ...
        <div className="heading-widget-div">
          <div className="row heading-widget-title">
            ...
            <div className="widget-content pull-right"
              ...
              <button className="fa fa-arrow-up arrow-icon"
                      style={{
                        display: this.props.index > 0 ? "inherit" : "none"
                      }}
              ...
              <button className="fa fa-arrow-down arrow-icon"
                      style={{
                        display: (this.props.index < this.props.widgetListSize
                            - 1) ? "inherit" : "none"
                      }}
              ...
              {
                <span className="p-1"><select className="widget-selector"
                                              id="role-select1"
          ...
          </div>
          {
            ...
            <div className="input-field-section">
                    <textarea className="form-control form-control-elements"
                              id="textarea" rows="3"
                              placeholder="Lorem ipsum" style={{
          ...
          }
          {
            ...
            <div className="input-field-section">
                    <textarea className="form-control form-control-elements"
                              ...
                              value={this.state.widget.text}
                    />
              <select className="form-control form-control-elements"
                      id="role-list-type"
                      style={{display: this.props.preview ? "none" : "inherit"}}
                      onChange={this.changeOrderList}
              ...
              <div style={{display: this.props.preview ? "inherit" : "none"}}>
                ...
                <div>
                  {
                    this.state.widget.style === "Ordered" && <ol>
                      {this.state.widget.text.split("\n").map(i =>
                          <li> {i}</li>
                      )}
                    </ol>
                  }
                  {this.state.widget.style === "UnOrdered" && <ul>
                    {this.state.widget.text.split("\n").map(i =>
                        <li> {i}</li>
                    )}
                  </ul>
...

          {
            this.state.widget.type === "Heading" &&
            <div className="input-field-section">
              <input className="form-control form-control-elements" id="heading"
              ...
              <input className="form-control form-control-elements"
                     id="heading-widget" placeholder="Widget name"
                     style={{display: this.props.preview ? "none" : "inherit"}}
                     onChange={this.changeName}
                     value={this.state.widget.name}
              />
              ...
              <div style={{display: this.props.preview ? "inherit" : "none"}}>
                ...
                <h5 className="form-control-elements">Preview </h5>
                {
                  ...
                  this.state.widget.size === 1 && <h1
                      className="form-control-elements">{this.state.widget.text}</h1>
                }

                {

                  this.state.widget.size === 2 && <h2
                      className="form-control-elements">{this.state.widget.text}</h2>
                }

                {

                  this.state.widget.size === 3 && <h3
                      className="form-control-elements">{this.state.widget.text}</h3>
                }

                {

                  this.state.widget.size === 4 && <h4
                      className="form-control-elements">{this.state.widget.text}</h4>
                }

                {

                  this.state.widget.size === 5 && <h5
                      className="form-control-elements">{this.state.widget.text}</h5>
                }
